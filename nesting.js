...
function employeeUpdater() {
  let updatedArray = employees.filter((employee) => {
    return employee.firstName !== "Theo";
  });

  updatedArray.forEach((employee) => {
...
function removeDuplicates() {
  let uniques = [...new Set(workplaceAccidents)];

  return uniques;
}

//Proof I can do it with a nested loop:
// function removeDuplicates() {
//   let array = workplaceAccidents.slice();
...
function recordCleaner() {
  for (accident of myCar.accidents) {
